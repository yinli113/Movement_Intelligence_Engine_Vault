...
relationships:
  ...
  child_concepts: [ground_reaction_moment, pivoting_moment, foot_contact_moment, linear_impulse, angular_impulse]
  related_concepts: [ground_reaction_force, center_of_pressure, center_of_mass, moment_arm, angular_momentum]
  stable_anatomy: []
  golf_interpretation: []
  app_hypotheses: []
...
The first class is the moment of each measured [[ground_reaction_force|GRF]] about whole-body [[center_of_mass|COM]]. The second is the couple-like moment produced by the individual-foot GRFs about the combined [[center_of_pressure|COP]] and vertical axis. The third is the free torsional [[ground_reaction_moment|GRM]] acting directly at each foot-ground interface. These classes are mechanically distinct and must not be collapsed into a single magnitude.
...
| :--- | :--- | :--- |
| decomposes_into | [[ground_reaction_moment]] | GRF moment about COM. |
