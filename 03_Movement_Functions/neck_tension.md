...
Use this node when a golfer holds the head still by bracing. Follow the graph toward [[thoracic_rotation]], [[trail_shoulder_external_rotation]], [[toe_loading]], and [[functional_lines]] before treating the neck as an isolated issue.
