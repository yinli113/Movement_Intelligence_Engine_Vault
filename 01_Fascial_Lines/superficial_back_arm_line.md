...
It provides an anatomical continuation from trunk and scapular pathways to the upper limb without assigning a measured kinetic or tissue role from camera appearance.
...
The upper bridge is rib cage/[[thoracic_spine]] -> scapula -> [[shoulder_joint]] -> [[superficial_back_arm_line]], connecting proximally with [[spiral_line]] and relevant [[functional_lines]]. External golfer-ground mechanics do not prove force travelling through this line.
...
- Add source-located distal anatomy before using hand-level structural links.
