...
- Built out a full functional slice of the graph for `[[golf_swing]]`:
  ...
  - Myofascial Lines: `[[functional_line]]` and `[[deep_front_line]]`.
...
- Upgraded the requested sample notes for `[[functional_line]]`, `[[spiral_line]]`, `[[superficial_back_line]]`, `[[hip_internal_rotation]]`, `[[thoracic_rotation]]`, and `[[golf_swing_transition]]`.
...
- Linked the source to `[[superficial_back_line]]`, `[[lateral_line]]`, `[[spiral_line]]`, `[[functional_line]]`, `[[deep_front_line]]`, and `[[golf_swing_transition]]`.
