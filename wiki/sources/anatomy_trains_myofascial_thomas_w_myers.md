...
relationships:
  contains: [superficial_back_line, lateral_line, spiral_line, functional_line, deep_front_line, sacrotuberous_ligament, thoracolumbar_fascia, plantar_fascia, nuchal_ligament, iliotibial_tract]
...
- The [[functional_line]] can be used as a cross-body force-transfer model involving shoulder girdle, trunk fascia, pelvis, and lower limb relationships.
...
- [[hip_internal_rotation]] -> [[functional_line]] -> [[trail_shoulder_external_rotation]]
